...
SELECT a.company, a.num, a.stop, b.stop as bstop
...
The query shown is similar to the previous one, however by joining two copies of the stops table wecan refer to 
...
SELECT a.company, a.num, stopa.name as aname, stopb.name as bname
FROM route a JOIN route b ON
  (a.company=b.company AND a.num=b.num)
